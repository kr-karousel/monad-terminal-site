...
function initChart(){
  ...
  if(tvContainer){
    var CHART_SRC = 'https://dexscreener.com/monad/0x714a2694c8d4f0b1bfba0e5b76240e439df2182d?embed=1&theme=dark&trades=0&info=0';
    tvContainer.innerHTML = '<iframe src="'+CHART_SRC+'" style="width:100%;height:360px;border:none;display:block" allow="clipboard-write" loading="eager" title="EMO/MON Chart"></iframe>';
  ...
  (function(){
    ...
    var chartSrc = 'https://dexscreener.com/monad/0x714a2694c8d4f0b1bfba0e5b76240e439df2182d?embed=1&theme=dark&trades=0&info=0';
    ...
    function recoverIframe(){
      ...
      if(!iframe || !iframe.src || iframe.src==='about:blank'){
        ...
        c.innerHTML = '<iframe src="'+chartSrc+'" style="width:100%;height:360px;border:none;display:block" allow="clipboard-write" loading="eager" title="EMO/MON Chart"></iframe>';
        return;
      }
