...
function initChart(){
  ...
  (function(){
    ...
    var iframeSrc = 'https://dexscreener.com/monad/0x714a2694c8d4f0b1bfba0e5b76240e439df2182d?embed=1&theme=dark&trades=0&info=0';
    ...
    function forceRepaint(){
      ...
      if(!iframe || !iframe.src || iframe.src==='about:blank'){
        c.innerHTML='<iframe src="'+iframeSrc+'" style="width:100%;height:360px;border:none;display:block;transform:translate3d(0,0,0);-webkit-transform:translate3d(0,0,0)" allow="clipboard-write" loading="eager" title="EMO/MON Chart"></iframe>';
        return;
      }
