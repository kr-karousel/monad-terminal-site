...
async function _handler(req, res) {
  ...
  if (action === 'generate') {
    ...
    const COMPOSITION = 'COMPOSITION: large close-up portrait — the face must be BIG and fill the frame. Face occupies the LEFT 55% of the image horizontally. RIGHT frame edge slices through the face just past the right eye. VERTICAL FRAMING: eyes at approximately 45% from top, chin at approximately 80% from top, upper body/outfit visible in bottom 15-20% only. The top of the head bleeds OFF the top edge — not fully visible. Do NOT shrink or zoom out the character. Do NOT center. Accessories may bleed off any edge.';
