...
async function _handler(req, res) {
  ...
  if (action === 'generate') {
    ...
    const COMPOSITION = 'COMPOSITION: face occupies the LEFT 55% of the image. Head and spikes bleed off the top and left edges. RIGHT frame edge slices through the face just past the right eye. The eyes must sit in the MIDDLE vertical zone of the image — do NOT push the face up or down. ZOOM LEVEL IS LOCKED — the face must occupy approximately 55-65% of the image HEIGHT; at least one head spike must be clearly visible at the top; the chin and upper body/outfit must be visible at the bottom. Do NOT zoom in so that the face fills the entire frame — this is WRONG. Do NOT zoom out. Do NOT center. Accessories may bleed off any edge.';
