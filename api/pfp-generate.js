...
async function _handler(req, res) {
  ...
  if (action === 'generate') {
    ...
    const COMPOSITION = 'COMPOSITION: this is a close-up PFP portrait. Face occupies the LEFT 55% of the image horizontally. RIGHT frame edge slices through the face just past the right eye. VERTICAL FRAMING IS LOCKED — eyes must sit at approximately 45% from the top of the image; chin at approximately 75% from top; upper body/outfit visible in the bottom 25%. The top of the head and spikes bleed OFF the top edge — the head is NOT fully visible, it is cropped at the top. Do NOT zoom out to show the full head — this is WRONG. Do NOT zoom in so the face fills the entire frame — this is also WRONG. Do NOT center. Accessories may bleed off any edge.';
