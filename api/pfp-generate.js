...
async function _handler(req, res) {
  ...
  if (action === 'generate') {
    ...
    const ART_STYLE = chogStyle === '2'
      ? 'ART STYLE: ALL lines — outlines, eye marks, eyelid strokes, mouth — must be THICK BOLD BLACK (same heavy weight as the base image outlines). Pure flat solid colors, no gradients, no shading. Large circular anime eyes. Cute chibi proportions. NOSE: small dark mark — always visible. MOUTH IS REPLACED BY CIGARETTE (LOCKED): thick lit cigarette hangs from corner of mouth — never omit, never replace with normal mouth.'
      : 'ART STYLE: ALL lines — outlines, eye marks, eyelid strokes, mouth — must be THICK BOLD BLACK (same heavy weight as the base image outlines). Pure flat solid colors, no gradients, no shading. Large circular anime eyes. Cute chibi proportions. FACE FEATURES: preserve nose (tiny dark dot) and mouth (thin curved line) exactly as base — same line weight, do not omit.';
