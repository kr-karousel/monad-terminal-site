...
async function _handler(req, res) {
  ...
  if (action === 'generate') {
    ...
    const OUTLINE_STYLE = 'OUTLINE STYLE IS LOCKED — CHOG\'s outlines are thick bold black lines with ROUGH, HEAVILY TEXTURED quality; the lines are visibly uneven, jagged, and irregular as if drawn aggressively with a thick brush or marker — NOT smooth, NOT clean, NOT geometric. The roughness and texture of the line edges must be clearly visible and exaggerated. Do NOT smooth or polish the outlines under any circumstances.';
