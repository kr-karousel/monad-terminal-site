...
async function _handler(req, res) {
  ...
  if (action === 'generate') {
    ...
    const COMPOSITION = 'COMPOSITION: preserve EXACTLY the composition, framing, camera distance, character scale, and positioning of the provided base CHOG image — do NOT change the zoom level, angle, crop, or how much of the character is visible. The output must look like the same shot as the base image, with only the hair/accessories/outfit changed.';
