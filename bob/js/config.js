...
//  CONFIG
// ═══════════════════════════════════════
const CHOG_CONTRACT = '0x21E325B059Cd83d4037C82F0F5998Ba2dF3d7777'; // BOB token
const KURU_PAIR     = '0xE5a8f88C3DB25434b6B4320A8e14348C447dD7a8';
const NADFUN_POOL   = '0xE5a8f88C3DB25434b6B4320A8e14348C447dD7a8'; // BOB/WMON pool
...
var NICK_BANNED  = [
  ...
  'official','support','scam','bob_official','nadfun',
  'capricorn','monad','monad_team','0x'
];
var nickDB = {};

// ── 거래 알림 임계값
var MON_BIG   = 1000;   // 1,000 BOB 이상 플로팅
var MON_WHALE = 100000; // 100,000 BOB 이상 웨일
var SHOUT_COST = 2000;
const TOKEN_NAME = 'BOB';
...
function renderStatGrid(period){
  ...
  const bv = p.volumeBase?.[period] || 0;
